...
#include "TUError.h"
#include "TUType.h"
#include "TapBillboardModels.generated.h"
...
struct FAnnouncementStyleData
{
	...
	UPROPERTY(BlueprintReadOnly)
	FString default_text_color = "#FFFFFF";
...
USTRUCT(BlueprintType)
struct FBillboardNativeData
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly)
	FBillboardIconData close_btn_img;
	
};

USTRUCT(BlueprintType)
struct FBillboardAllDetailData
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly)
	FAnnouncementStyleData marquee;

	UPROPERTY(BlueprintReadOnly)
	FBillboardNativeData navigate;
