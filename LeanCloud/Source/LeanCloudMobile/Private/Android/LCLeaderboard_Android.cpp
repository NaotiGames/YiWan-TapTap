...
#define LCLeaderboardUE "com/tapsdk/lc/LCLeaderboardUE"
...
FLCLeaderboardStatistic FLCLeaderboard_CovertStatistic(const LCJNI::JNI& LCJNI, const LCJNI::Object& object) {
	...
	auto User = LCJNI.CallObjectMethod(object, "getUser", "()Lcom/tapsdk/lc/LCUser;");
	UE_Statistic.User = LCJavaHelper::ConvertUser(User);
	auto Object = LCJNI.CallObjectMethod(object, "getObject", "()Lcom/tapsdk/lc/LCObject;");
	UE_Statistic.Object = LCJavaHelper::ConvertObject(Object);
...
FLCLeaderboardRanking FLCLeaderboard_CovertRanking(const LCJNI::JNI& LCJNI, const LCJNI::Object& object) {
	...
	auto User = LCJNI.CallObjectMethod(object, "getUser", "()Lcom/tapsdk/lc/LCUser;");
	UE_Ranking.User = LCJavaHelper::ConvertUser(User);
	auto Object = LCJNI.CallObjectMethod(object, "getObject", "()Lcom/tapsdk/lc/LCObject;");
	UE_Ranking.Object = LCJavaHelper::ConvertObject(Object);
...
extern "C" {
#endif
	JNIEXPORT void Java_com_tapsdk_lc_LCLeaderboardUE_onStatisticsError(JNIEnv* jenv, jclass thiz, jint code, jstring Message, jint callBackID) {
	...
	JNIEXPORT void Java_com_tapsdk_lc_LCLeaderboardUE_onStatisticsSuccess(JNIEnv* jenv, jclass thiz, jobject statistics, jint callBackID) {
		auto CallBackPtr = StatisticsCallBacks.Find(callBackID);
		if (CallBackPtr == nullptr) {
			return;
		}
	...
	JNIEXPORT void Java_com_tapsdk_lc_LCLeaderboardUE_onRankingsError(JNIEnv* jenv, jclass thiz, jint code, jstring Message, jint callBackID) {
	...
	JNIEXPORT void Java_com_tapsdk_lc_LCLeaderboardUE_onRankingsSuccess(JNIEnv* jenv, jclass thiz, jobject rankings, jint count, jint callBackID) {
		auto CallBackPtr = RankingsCallBacks.Find(callBackID);
		if (CallBackPtr == nullptr) {
			return;
		}
