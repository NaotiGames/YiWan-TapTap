...
{
	public TapConnect(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.IOS)
		{
			PublicAdditionalFrameworks.Add(
				new Framework(
					"TapConnectSDK",
					"../ThirdParty/iOS/Frameworks/TapConnectSDK.zip",
		...
		if (Target.Platform == UnrealTargetPlatform.Android)
		{
			...
			AdditionalPropertiesForReceipt.Add(
				"AndroidPlugin",
				Path.Combine(ModuleDirectory, "TapConnect_Android_UPL.xml")
			);
		}
	}
}
