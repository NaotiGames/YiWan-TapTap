...
void FTapLicenseAndroid::SetTestEnvironment(bool bIsTest){
	TapJNI::JNI JNI;
	auto ClassObject = JNI.FindClass(TapLicenseUE);
	JNI.CallStaticVoidMethod(ClassObject, "setTestEnvironment", "(ZLandroid/app/Activity;)V", bIsTest, *JNI.GetActivity());
}
