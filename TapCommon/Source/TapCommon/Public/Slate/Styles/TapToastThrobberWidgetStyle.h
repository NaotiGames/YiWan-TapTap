...
#include "TapToastThrobberWidgetStyle.generated.h"

/**
 * 
 */
USTRUCT(BlueprintType)
struct TAPCOMMON_API FTapToastThrobberStyle : public FSlateWidgetStyle
{
	GENERATED_USTRUCT_BODY()

	FTapToastThrobberStyle();
	virtual ~FTapToastThrobberStyle();

	// FSlateWidgetStyle
	virtual void GetResources(TArray<const FSlateBrush*>& OutBrushes) const override;
	static const FName TypeName;
	virtual const FName GetTypeName() const override { return TypeName; };
	static const FTapToastThrobberStyle& GetDefault();
...
class UTapToastThrobberWidgetStyle : public USlateWidgetStyleContainerBase
{
	GENERATED_BODY()
...
public:
	...
	FTapToastThrobberStyle WidgetStyle;
